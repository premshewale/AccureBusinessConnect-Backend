...
import com.accuresoftech.abc.enums.*;
...
public class LeadServiceImpl implements LeadService {
    ...
    public LeadResponse convertLeadToCustomer(LeadConversionRequest request) {
        ...
        logActivity(lead, "CONVERT_TO_CUSTOMER", lead.getStatus().name(), LeadStatus.WON.name(), "Lead converted to customer");
    ...
    public LeadResponse updateLeadStatus(Long id, String status) {
        ...
        if (newStatus == LeadStatus.WON && lead.getCustomer() == null) {
            Customer customer = Customer.builder()
                    ...
                    .phone(lead.getPhone())
                    .industry("Auto")
                    .address("Auto-generated from Lead")
                    .website("N/A")
                    .type(CustomerType.REGULAR)
                    .status(CustomerStatus.ACTIVE)
                    .assignedUser(lead.getOwner())
                    .department(lead.getDepartment())
                    .tags("Auto-converted from Lead")
                    .build();
            ...
            logActivity(lead, "AUTO_CONVERT", currentStatus.name(), newStatus.name(), "Lead auto-converted to customer");
        }
